...
export namespace Prisma {
  ...
  */
  ...
  type organsCountArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    Omit<organsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
  ...
  export interface organsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends organsCountArgs>(
      args?: Subset<T, organsCountArgs>,
    ): Prisma.PrismaPromise<
      T extends $Utils.Record<'select', any>
        ? T['select'] extends true
          ? number
    ...
    **/
    ...
    >(args: SubsetIntersection<T, organsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOrgansGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
  /**
