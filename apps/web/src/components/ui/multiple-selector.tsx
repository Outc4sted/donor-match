...
interface MultipleSelectorProps {
  ...
  readonly defaultOptions?: Option[]
  ...
  /** Empty component. */
  readonly emptyIndicator?: React.ReactNode
   ...
   **/
  readonly triggerSearchOnFocus?: boolean
  /** Async search */
  readonly onSearch?: (value: string) => Promise<Option[]>
  /**
   * Sync search. This search will not showing loadingIndicator.
   * The rest props are the same as async search.
   * i.e.: creatable, groupBy, delay.
   **/
  readonly onSearchSync?: (value: string) => Option[]
  readonly onChange?: (options: Option[]) => void
  /** Limit the maximum number of selected options. */
  readonly maxSelected?: number
  /** When the number of selected options exceeds the limit, the onMaxSelected will be called. */
  readonly onMaxSelected?: (maxLimit: number) => void
  /** Hide the placeholder when there are options selected. */
  readonly hidePlaceholderWhenSelected?: boolean
  ...
  readonly hideClearAllButton?: boolean
}
